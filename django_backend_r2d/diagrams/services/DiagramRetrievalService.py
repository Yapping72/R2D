...
class DiagramRetrievalService(BaseDiagramRetrievalService):
    def __init__(self):
        ...
        # To add new diagrams, simply add new repositories responsible for crafting a new key-value pair in the diagrams dictionary
        self.class_diagram_repo = ClassDiagramRepository()
        self.sequence_diagram_repo = SequenceDiagramRepository()
        self.er_diagram_repo = ERDiagramRepository()
