...
class ClassDiagram(models.Model):
    ...
    model_id: str - The model id that the class diagram is generated
    ...
    classes: str - The classes in the diagram
    ...
    model_name = models.ForeignKey(ModelName, on_delete=models.CASCADE)  # Correct field name
