...
class ClassDiagramServiceTests(TestCase):
    ...
    def setUp(self):
        ...
        self.class_diagram_service = ClassDiagramService(
            ...
            auditor_factory=self.auditor_factory,
    ...
    def test_generate_diagram_success(self):
        ...
        """
        try:
            result = self.class_diagram_service.generate_diagram(self.job_id, self.job_payload)
    ...
    def test_generate_diagram_success_with_context(self):
        ...
        try:
            context = {
                "context": "AWS CloudWatch strongly recommends adding a separate SIT_CAPSTONE_YP class alongside CloudWatch class to monitor the logs. This MUST be incorporated within the diagram."
            }
            result = self.class_diagram_service.generate_diagram(self.job_id, self.job_payload, analysis_context=context)
