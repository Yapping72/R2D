...
class BaseChainInput(ABC):
    ...
    """
    def __init__(self, model_prompt_template:BasePromptTemplate, audit_prompt_template:BasePromptTemplate, analysis_context=None, audit_criteria=None, model_response_schema=None, auditor_response_schema=None):
